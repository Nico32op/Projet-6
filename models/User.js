...
const userSchema = mongoose.Schema({
  //on créé un schéma de donné           unique permet de ne pas pouvoir enregister 2 même comptes
  email: { type: String, required: true, unique: true }, //on créé différents objets dont notre schéma aura besoin, on dit le type ainsi que leur caractère (obligatoire ou non)
